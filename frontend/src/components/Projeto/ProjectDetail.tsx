...
import ProjectDetailTabs, { type Tab } from "./ProjectDetailTabs";
...
import LoadingRow from "./ProjectDetailLoadingRow";
import MRStateBadge from "./ProjectDetailMRStateBadge";
...
import VMCard from "./ProjectDetailVMCard";
...
export default function ProjectDetail({ project }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* GraphQL status */}
      {loading && <LoadingRow message="Carregando dados do GitLab…" />}
      {error && (
      ...
      {data?.pipelines[0] && (
        <ProjectDetailPipelineStatusBanner pipeline={data.pipelines[0]} />
      )}
      {/* Tabs */}
      <ProjectDetailTabs
        activeTab={activeTab}
      ...
      {/* Tab: Visão Geral */}
      {activeTab === "overview" && (
        <ProjectDetailOverview languages={project.languages} />
      )}
      {/* Tab: Branches */}
      {activeTab === "branches" && (
      ...
      {activeTab === "infra" && (
        <div className="space-y-4">
          {infraLoading && <LoadingRow message="Consultando infraestrutura…" />}
          {infraError && (
